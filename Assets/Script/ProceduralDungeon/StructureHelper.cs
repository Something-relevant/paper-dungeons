...
public static class StructureHelper
{
    ...
    {
        //this method is universal to traverse nodes up tree
    ...
    public static Vector2Int GenerateBottomLeftCornerBetween(
        ...
        float pointModifier, //times the width of the room to vary sizes for random choice
        int offset) //offset from other walls if = 0 only one wall seperates space
    {
    ...
    public static Vector2Int GenerateBottomRightCornerBetween(
    Vector2Int boundaryLeftPoint,
    Vector2Int boundaryRightPoint,
    float pointModifier, //times the width of the room to vary sizes for random choice
    int offset) //offset from other walls if = 0 only one wall seperates space
