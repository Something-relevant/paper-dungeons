...
public class CorridorNode : Node
{
    ...
    private void ProcessRoomInRelationUpOrDown(Node structure1, Node structure2)
    {
        ...
        var sortedBottomStructure = structureBottomChildren.OrderByDescending(child => child.TopLeftAreaCorner.y).ToList();
    ...
    {
        if (topNodeLeft.x < bottomNodeLeft.x && bottomNodeRight.x < topNodeLeft.x)
        {
    ...
    //checks if point(corner) of structure 1 is inbetween corners of structure 2
